...
MatrixTRUNGLE::MatrixTRUNGLE()
    :Matrix(){}

MatrixTRUNGLE::MatrixTRUNGLE(const unsigned int rows, const unsigned int cols)
    :Matrix(rows, cols) {}

void MatrixTRUNGLE::printTRUNGLE()
{
    cout << endl<<"MATRIXTRUNGLE"<<endl;
